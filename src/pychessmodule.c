...
time_limited_iterative_deepening_search(PyObject *self, PyObject *args)
{
    ...
    // --- Run the core search ---
    const int score = timeLimitedIterativeDeepeningSearch(&board, maxDepth, color, durationSeconds);
...
static PyMethodDef PyChessMethods[] = {
    {"time_limited_iterative_deepening_search", time_limited_iterative_deepening_search, METH_VARARGS, "Call time_limited_iterative_deepening_search function"},
    {NULL, NULL, 0, NULL}
};
